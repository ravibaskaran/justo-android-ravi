              ...
              {props?.formData?.property_id ? (
                <View style={styles.inputWrap}>
                  <DropdownInput
                    ...
                    valueField={"_id"}
                    value={props?.formData?.for_sm_id}
                ...
                <>
                  <View style={[styles.inputWrap]}>
                    <DropdownInput
                      ...
                      data={masterDatas.filter((item: any) => {
                        return [
                          CONST_IDS.cp_lead_source_id,
                          CONST_IDS.ref_partner_lead_source_id,
                        ].includes(item?._id);
                    ...
                    <>
                      ...
                      <View style={styles.inputWrap}>
                        <DropdownInput
                          ...
                          search={true}
                          searchPlaceholder={
                            strings.search + " " + strings.company
                          }
          ...
          {/* <View style={styles.inputContVw}>
            <View style={styles.smallContVw}>
              <TextInput
                ...
                onBlur={() => {
                  const currentValue = props?.formData?.min_budget?.toString();
            ...
            <View style={[styles.smallContVw, { justifyContent: "flex-end" }]}>
              <TextInput
                ...
                onBlur={() => {
                  const currentValue = props?.formData?.max_budget?.toString();
                  if (currentValue?.endsWith(".")) {
                    props.setFormData({
                      ...props.formData,
          ...
          {/* <View style={styles.inputContVw}>
            <View style={styles.smallContVw}>
              <TextInput
                ...
                onBlur={() => {
                  const currentValue =
                    props?.formData?.min_emi_budget?.toString();
                  if (currentValue?.endsWith(".")) {
                    props.setFormData({
                      ...props.formData,
            ...
            <View style={[styles.smallContVw, { justifyContent: "flex-end" }]}>
              <TextInput
                ...
                onBlur={() => {
                  const currentValue =
                    props?.formData?.max_emi_budget?.toString();
                  if (currentValue?.endsWith(".")) {
                    props.setFormData({
                      ...props.formData,

...
const AddAppointmentScreen = ({ navigation, route }: any) => {
  ...
  const editAppointmentData =
    useSelector((state: any) => state.editAddAppointment) || {};
  ...
  const validation = () => {
    ...
    if (type === "reSheduled") {
      if (
        appointMentForm.update_type == undefined ||
        appointMentForm.update_type == ""
      ) {
        isError = false;
    ...
    if (appointMentForm.lead_id == undefined || appointMentForm.lead_id == "") {
      ...
      appointMentForm.property_id == undefined ||
      appointMentForm.property_id == ""
    ) {
      isError = false;
      errorMessage =
        "Property Name is require. Please Select the Property Name";
    } else if (
      appointMentForm.appointment_date == undefined ||
      appointMentForm.appointment_date == ""
    ) {
      isError = false;
      errorMessage = "Date is require. Please Select the Date";
    } else if (
      appointMentForm.appointment_time == undefined ||

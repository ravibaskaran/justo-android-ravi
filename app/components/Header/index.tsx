...
const Header = (props: any) => {
  ...
  const notificationCount =
    response?.notification_count !== 0 ? response?.notification_count : 0;
  return (
    <>
      <View
        style={{
      ...
      <StatusBar
        ...
        backgroundColor={
          props.statusBarColor ? props.statusBarColor : PRIMARY_THEME_COLOR
        }
      />
      <View style={[styles.maincontainer, props.headerStyle]}>
        ...
        <View style={styles.rightIconsWrap}>
          ...
          {props.rightSecondImageScr ? (
            <TouchableOpacity
              onPress={() => {
                props.handleOnRightSecondIconPress
                  ? props.handleOnRightSecondIconPress()

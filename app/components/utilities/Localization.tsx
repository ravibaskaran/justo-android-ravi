...
const strings = new LocalizedStrings({
  en: {
    ...
    mobileNoValidReqVal:
      "Mobile No. should be 10 digits. Please enter correct Mobile No.",
    mobileAlreadyValidReqVal:
      "Mobile No. is already registered. Please enter other Mobile No.",
    reraNumberAlreadyValidReqVal:
      "RERA No. is already registered. Please enter other RERA No.",
    whatsappNoReqVal: "WhatsaApp No. is require. Please enter WhatsaApp No.",
    whatsappNoValidReqVal:
      "WhatsaApp No. should be 10 digits. Please enter correct WhatsaApp No.",
    ...
    reraCertImgReqVal:
      "RERA Certificate is require. Please Choose RERA Certificate",
    noReraRegReqVal:
      "If you have not RERA certificate. Please click on no registerd for RERA",
    propDeclrLttrImgReqVal:
      "Proprietorship Declaration Letter is require. Please Choose Proprietorship Declaration Letter",
    DeclrLttrImgReqVal:
      "Declaration Letter is require. Please Choose Declaration Letter",
    cancelChqImgReqVal:
      "Cancel Cheaque is require. Please Choose Cancel Cheaque",
    ...
    accountNoValidVal:
      "Account No. is not entered correctly. Please enter Account No. Correctly",
    ifscReqVal: "IFSC Code is require. Please enter IFSC Code",
    ifscValidVal:
      "IFSC Code is not entered correctly. Please enter IFSC Code Correctly",
    agencyNameReqVal:
      "Real Estate Company is require. Please enter Company Name",
    ...
    declLttrComImgReqVal:
      "Declaration letter of company is require. Please Choose Declaration letter of company",
    reraRegstrReqVal:
    ...
    appointMentDateReqVal:
      "Appointment Date is require. Please Select the Appointment Date Status",
    appointMentTimeReqVal:
      "Appointment Time is require. Please Select the Appointment Time Status",
    pickupLocationReqVal:
      "Pickup Location is require. Please Select the Pickup Location",
    pickupAreaReqVal: "Pickup Area is require. Please Select the Pickup Area",
    noOfGuestReqVal:
      "Number Of Guest is require. Please Enter the Number Of Guest",
    followUpStatusReqVal:
    ...
    usernamepasswordempty:
      "Username and Password is require. Please enter Username and password",
    ...
    txt_setting_heading_microPhone:
      "Justo Would Like to Access Your MicroPhone",
